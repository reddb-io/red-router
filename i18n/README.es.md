<div align="center">
  <img src="../images/red-router.png?1" alt="Panel de control de RedRouter" width="800"/>
  
  # RedRouter - Enrutador de IA GRATUITO y ahorrador de tokens
  ...
  **Conecta todas tus herramientas de código con IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a más de 40 proveedores de IA y más de 100 modelos.**
  ...
  [![npm](https://img.shields.io/npm/v/red-router.svg)](https://www.npmjs.com/package/red-router)
  [![Downloads](https://img.shields.io/npm/dm/red-router.svg)](https://www.npmjs.com/package/red-router)
  ...
  [![License](https://img.shields.io/npm/l/red-router.svg)](https://github.com/reddb-io/red-router/blob/main/LICENSE)


[🚀 Inicio rápido](#-inicio-rápido) • [💡 Características](#-características-principales) • [📖 Configuración](#-guía-de-instalación) • [🌐 Sitio web](https://github.com/reddb-io/red-router)
...
El paquete de este repositorio es privado (`red-router-app`), por lo que ejecutar desde el código fuente/Docker es la ruta de desarrollo local prevista.
...
<table>
  ...
  <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
    <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với RedRouter" width="300"/>
  </a><br/>
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với RedRouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="RedRouter + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>RedRouter + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="RedRouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>RedRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="RedRouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>RedRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with RedRouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + RedRouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup RedRouter 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy RedRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy RedRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **¿Has hecho un video sobre RedRouter?** Envía una [Pull Request](https://github.com/reddb-io/red-router/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!

---

## 🛠️ Herramientas CLI compatibles

RedRouter funciona a la perfección con todas las principales herramientas de código con IA:
...
Headroom es opcional y se ejecuta por separado. RedRouter llama al endpoint local `/v1/compress` de Headroom y luego mantiene el enrutamiento, la reserva, la autenticación y el seguimiento de uso normales:

```
Client → RedRouter → Headroom /v1/compress → RedRouter → provider
```
...
Si Headroom está caído o devuelve un error, RedRouter falla de forma segura y envía la solicitud original.
...
- Tu herramienta CLI envía el formato OpenAI → RedRouter lo traduce → El proveedor recibe el formato nativo
...
> RedRouter por sí mismo **nunca te cobra** nada. Solo pagas a los proveedores directamente (si usas servicios de pago).
>
...
### 📊 Cómo entender los costes y la facturación de RedRouter

**Realidad de la facturación de RedRouter:**

✅ **El software de RedRouter = GRATUITO para siempre** (código abierto, nunca cobra)  
...
❌ **RedRouter nunca envía facturas** ni carga tu tarjeta
...
- **Proveedores económicos** (GLM, MiniMax): Págales directamente, RedRouter solo enruta
- **Proveedores GRATUITOS** (iFlow, Kiro, Qwen): Realmente gratuitos para siempre, sin cargos ocultos
- **RedRouter**: Nunca cobra nada, jamás
...
El panel realiza el seguimiento de tu uso de tokens y muestra **costes estimados** como si estuvieras usando APIs de pago directamente. Esto **no es facturación real** — es una referencia para mostrar cuánto estás ahorrando al usar modelos gratuitos o suscripciones existentes a través de RedRouter.
...
<details>
<summary><b>💳 ¿RedRouter me cobrará algo?</b></summary>

**No.** RedRouter es un software gratuito y de código abierto que se ejecuta en tu propio ordenador. Nunca te cobra nada.

**Solo pagas:**

- ✅ **Proveedores de suscripción** (Claude Code $20/mes, Codex $20-200/mes) → Págales directamente en sus sitios web
- ✅ **Proveedores económicos** (GLM, MiniMax) → Págales directamente, RedRouter solo enruta tus solicitudes
- ❌ **El propio RedRouter** → **Nunca cobra nada, jamás**

RedRouter es un proxy/enrutador local. No tiene tu tarjeta de crédito, no puede enviar facturas y no tiene sistema de facturación. Es software totalmente gratuito.
...
RedRouter solo enruta tus solicitudes hacia ellos — no hay "trampa" ni facturación futura. Son servicios realmente gratuitos y RedRouter los hace fáciles de usar con soporte de reserva.
...
3. **Usa los proveedores de suscripción al final:**
   ...
   - RedRouter te ayuda a maximizar su valor mediante el seguimiento de cuota
...
La reserva inteligente de RedRouter evita cargos sorpresa:
...
**Tú tienes el control:** Establece límites de gasto por proveedor en el panel y RedRouter los respeta.
...
**Consejo profesional:** Usa Opus para tareas complejas y Sonnet para velocidad. ¡RedRouter realiza el seguimiento de la cuota por modelo!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el panel de red-router]
...
```json
{
  ...
  "anthropic_api_key": "tu-clave-api-de-red-router"
}
```
...
export OPENAI_API_KEY="tu-clave-api-de-red-router"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "red-router/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Nota:** OpenClaw solo funciona con RedRouter local. Usa `127.0.0.1` en lugar de `localhost` para evitar problemas de resolución IPv6.
...
export NEXT_PUBLIC_CLOUD_URL="https://github.com/reddb-io/red-router"
...
docker pull ghcr.io/reddb-io/red-router:latest   # actualiza a la última versión
```

**Persistencia de datos:** `$HOME/.red-router/db/data.sqlite` en el host ↔ `/app/data/db/data.sqlite` en el contenedor.

### Variables de entorno

| Variable                                             | Por defecto                                | Descripción                                                                          |
| ---------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------ |
| `JWT_SECRET`                                         | Generado automáticamente (`~/.red-router/jwt-secret`) | Secreto de firma JWT para la cookie de autenticación del panel (sobreescríbelo para compartir entre instancias) |
| `INITIAL_PASSWORD`                                   | `123456`                                   | Contraseña del primer inicio de sesión cuando no existe un hash guardado             |
| `DATA_DIR`                                           | `~/.red-router`                               | Ubicación principal de datos de la app (SQLite en `$DATA_DIR/db/data.sqlite`)        |
...
| `CLOUD_URL`                                          | `https://github.com/reddb-io/red-router`                      | URL base del endpoint de sincronización en la nube del lado del servidor             |
...
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://github.com/reddb-io/red-router`                      | URL de nube pública/compatible (prefiere `CLOUD_URL` para el runtime del servidor)   |
...
- Tanto `${DATA_DIR}` como `~/.red-router` resuelven a la misma ubicación en un contenedor de Docker — el enlace simbólico `/root/.red-router -> /app/data` se crea en tiempo de compilación.
...
- RedRouter lo renueva automáticamente
...
- **Sitio web**: [github.com/reddb-io/red-router](https://github.com/reddb-io/red-router)
- **GitHub**: [github.com/reddb-io/red-router](https://github.com/reddb-io/red-router)
- **Problemas**: [github.com/reddb-io/red-router/issues](https://github.com/reddb-io/red-router/issues)

---

## 👥 Colaboradores

¡Gracias a todos los colaboradores que ayudaron a mejorar RedRouter!

[![Contributors](https://contrib.rocks/image?repo=ghcr.io/reddb-io/red-router&max=150&columns=15&anon=1&v=20260309)](https://github.com/reddb-io/red-router/graphs/contributors)

---

## 📊 Gráfico de estrellas

[![Star Chart](https://starchart.cc/ghcr.io/reddb-io/red-router.svg?variant=adaptive)](https://starchart.cc/ghcr.io/reddb-io/red-router)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Un fork de RedRouter en TypeScript con todas las funciones. Añade más de 36 proveedores, reserva automática de 4 niveles, APIs multimodales (imágenes, embeddings, audio, TTS), interruptor de circuitos, caché semántica, evaluaciones de LLM y un panel pulido. Más de 368 pruebas unitarias. Disponible a través de npm y Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — ahorrador de tokens en Rust. RedRouter porta su pipeline de compresión a JS → **−20-40% de tokens de entrada** en cada solicitud.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. RedRouter adapta su prompt → **−65% de tokens de salida**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — habilidad del _"dev sénior perezoso"_. RedRouter inyecta su jerarquía primero-YAGNI → **menos tokens, menos código, diffs más cortos**.

Un enorme agradecimiento a estos autores — sin su trabajo, las funciones de ahorro de tokens de RedRouter no existirían. ¡Dales una ⭐ en GitHub!
