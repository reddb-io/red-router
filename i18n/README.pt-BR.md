<div align="center">
  <img src="../images/red-router.png?1" alt="Painel do RedRouter" width="800"/>
  
  # RedRouter — roteador de IA GRATUITO e economizador de tokens
  ...
  **Conecte todas as ferramentas de código de IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a mais de 40 provedores de IA e mais de 100 modelos.**
  ...
  [![Licença](https://img.shields.io/npm/l/red-router.svg)](https://github.com/reddb-io/red-router/blob/main/LICENSE)


[🚀 Início rápido](#-início-rápido) • [💡 Recursos](#-principais-recursos) • [📖 Configuração](#-guia-de-configuração) • [🌐 Site](https://github.com/reddb-io/red-router)
...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           RedRouter (Roteador inteligente)            │
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no RedRouter<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>RedRouter + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
      ...
      <b>🇺🇸 Inglês</b><br/>
      <sub>RedRouter + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com RedRouter 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + RedRouter<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida RedRouter 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante RedRouter no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=hPusYX-5Pmw">
        <img src="https://img.youtube.com/vi/hPusYX-5Pmw/maxresdefault.jpg" alt="Hướng Dẫn Setup OpenClaw + RedRouter: Tạo Bot Zalo AI Tự Động Từ A-Z" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + RedRouter: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
> 🎬 **Fez um vídeo sobre o RedRouter?** Envie um [Pull Request](https://github.com/reddb-io/red-router/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!

---

## 🛠️ Ferramentas CLI suportadas

RedRouter funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
O headroom é opcional e funciona separadamente. RedRouter chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → RedRouter → Headroom /v1/compress → RedRouter → provedor
```
...
- Sua ferramenta CLI envia formato OpenAI → RedRouter traduz → Provedor recebe formato nativo
...
> O próprio RedRouter **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do RedRouter!
...
### 📊 Compreendendo os custos e faturamento do RedRouter

**Como funciona o faturamento do RedRouter:**

✅ **Software RedRouter = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **RedRouter nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, RedRouter apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **RedRouter**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do RedRouter.
...
<details>
<summary><b>💳 Serei cobrado pelo RedRouter?</b></summary>

**Não.** RedRouter é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, RedRouter apenas encaminha suas solicitações
- ❌ **RedRouter em si** → **Nunca carrega nada, nunca**

RedRouter é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O RedRouter apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio RedRouter. Eles são serviços verdadeiramente gratuitos e o RedRouter os torna fáceis de usar com suporte alternativo.
...
- RedRouter ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do RedRouter evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o RedRouter os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. RedRouter rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do RedRouter]
...
> **Nota:** OpenClaw só funciona com RedRouter local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET` | Gerado automaticamente (`~/.red-router/jwt-secret`) | Segredo de assinatura JWT para cookie de autenticação do painel (substituir para compartilhar entre instâncias) |
...
| `NEXT_PUBLIC_CLOUD_URL` | `https://github.com/reddb-io/red-router` | URL de nuvem pública/compatível com versões anteriores (prefira `CLOUD_URL` para tempo de execução do servidor) |
...
- Atualizado automaticamente pelo RedRouter
...
- **Site**: [github.com/reddb-io/red-router](https://github.com/reddb-io/red-router)
...
Obrigado a todos os colaboradores que ajudaram a tornar o RedRouter melhor!

[![Contribuidores](https://contrib.rocks/image?repo=ghcr.io/reddb-io/red-router&max=150&columns=15&anon=1&v=20260309)](https://github.com/reddb-io/red-router/graphs/contributors)

---

## 📊 Gráfico de estrelas

[![Gráfico de estrelas](https://starchart.cc/ghcr.io/reddb-io/red-router.svg?variant=adaptive)](https://starchart.cc/ghcr.io/reddb-io/red-router)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Um fork TypeScript completo do RedRouter. Adiciona mais de 36 provedores, fallback automático de 4 camadas, APIs multimodais (imagens, incorporações, áudio, TTS), disjuntor, cache semântico, avaliações LLM e um painel sofisticado. Mais de 368 testes de unidade. Disponível via npm e Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O RedRouter porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. RedRouter adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. RedRouter injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do RedRouter não existiriam. Dê uma ⭐ a eles no GitHub!
