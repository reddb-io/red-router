...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/red-router/server.js.
...
function buildCliPackage() {
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.red-router/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.red-router/runtime)");
  }
  console.log("");
