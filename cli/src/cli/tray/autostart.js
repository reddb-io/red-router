...
const APP_LABEL = "com.red-router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when red-router is currently
 ...
 * SIGTERM to the running process. When the running red-router cli.js was itself
...
function enableWindows(cliPath) {
  ...
  // `red-router.cmd` lookup that depended on the npm prefix path.
