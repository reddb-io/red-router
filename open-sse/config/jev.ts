...
// Ported 1:1 from the legacy fork (open-sse/config/jev.js @ c66f917c).
//
...
export const JEV_TIERS = ["SIMPLE", "MEDIUM", "COMPLEX", "REASONING"] as const;

// Default criteria for the single `choice` question. Overridable per-combo via
// comboStrategies[name].smartCriteria.
export const JEV_DEFAULT_CRITERIA: Record<string, string> = {
  ...
  COMPLEX:
    "Multi-file changes, architecture, integration/design decisions, debugging across a system.",
  REASONING:
    "Hard algorithmic/mathematical reasoning, subtle concurrency/correctness proofs, deep analysis.",
};
