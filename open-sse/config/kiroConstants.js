 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what red-router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a red-router
 ...
 * The suffix is a red-router request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a red-router synthetic agentic variant.
...
/**
 * Detect whether a model id is a red-router synthetic thinking variant
...
/**
 * Resolve a red-router model id to the real upstream Kiro model id, plus flags
