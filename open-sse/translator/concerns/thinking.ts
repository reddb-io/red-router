...
// Ported 1:1 from the legacy fork (open-sse/translator/concerns/thinking.js @ c66f917c).
// Provider-specific application lives in thinkingUnified (see below); this file is maps-only.
