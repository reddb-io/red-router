 ...
 * into red-router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are red-router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic red-router variant set for a single upstream Kiro model.
 *
 ...
 * into red-router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
