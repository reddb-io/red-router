...
export const contextMenu = tv({
  slots: {
    content: popover({
      class: "min-w-48 p-[var(--reddb-spatial-inset-sm)] data-[state=open]:outline-none",
    }),
    group: "flex flex-col",
    ...
    item: [
      ...
      "data-[highlighted]:bg-foreground/10 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
    ].join(" "),
...
export type ContextMenuSize = NonNullable<ContextMenuVariants["size"]>;
