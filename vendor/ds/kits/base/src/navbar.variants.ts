...
export const navbar = tv({
  slots: {
    ...
    // language — neutral surface, full-weight ink, and a 2px Brand-red
    ...
    link: [
      "inline-flex w-auto items-center rounded-b-none border-b-2 border-transparent",
      "px-[var(--reddb-spatial-inset-sm)] py-[var(--reddb-spatial-gap-sm)] text-ink-muted no-underline",
      "hover:bg-foreground/8 hover:text-foreground",
      "aria-[current]:border-primary aria-[current]:bg-foreground/10 aria-[current]:font-medium aria-[current]:text-foreground",
    ].join(" "),
    panelLink: [
      "flex w-full items-center justify-start rounded-s-none border-s-2 border-transparent",
      "px-[var(--reddb-spatial-inset-sm)] py-[var(--reddb-spatial-gap-sm)] text-ink-muted no-underline",
      "hover:bg-foreground/8 hover:text-foreground",
      "aria-[current]:border-primary aria-[current]:bg-foreground/10 aria-[current]:font-medium aria-[current]:text-foreground",
    ].join(" "),
