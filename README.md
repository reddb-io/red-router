<div align="center">
  <img src="./images/red-router.png?1" alt="RedRouter Dashboard" width="800"/>
...
[🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://github.com/reddb-io/red-router)
...
<table>
  ...
  <tr>
    ...
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + RedRouter: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>by <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
    </td>
...
> 🎬 **Made a video about RedRouter?** Submit a [Pull Request](https://github.com/reddb-io/red-router/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

RedRouter works seamlessly with all major AI coding tools:
...
Headroom is optional and runs separately. RedRouter calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:
...
- Your CLI tool sends OpenAI format → RedRouter translates → Provider receives native format
...
> RedRouter itself **never charges** you anything. You only pay providers directly (if using paid services).
>
...
### 📊 Understanding RedRouter Costs & Billing

**RedRouter Billing Reality:**

✅ **RedRouter software = FREE forever** (open source, never charges)  
...
❌ **RedRouter never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, RedRouter just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **RedRouter**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through RedRouter.
...
<details>
<summary><b>💳 Will I be charged by RedRouter?</b></summary>

**No.** RedRouter is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**

- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, RedRouter just routes your requests
- ❌ **RedRouter itself** → **Never charges anything, ever**

RedRouter is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
RedRouter just routes your requests to them - there's no "catch" or future billing from RedRouter itself. They're truly free services, and RedRouter makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - RedRouter helps maximize their value through quota tracking
...
RedRouter's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and RedRouter respects them.
...
> **Note:** OpenClaw only works with local RedRouter. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET`                                         | Auto-generated (`~/.red-router/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances)   |
...
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://github.com/reddb-io/red-router`                    | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime)        |
...
- **Website**: [github.com/reddb-io/red-router](https://github.com/reddb-io/red-router)
...
Thanks to all contributors who helped make RedRouter better!
...
**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of RedRouter. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. RedRouter ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. RedRouter adapts its prompt → **−65% output tokens**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) by **[@DietrichGebert](https://github.com/DietrichGebert)** — _"lazy senior dev"_ skill. RedRouter injects its YAGNI-first ladder → **fewer tokens, less code, shorter diffs**.

Huge thanks to these authors — without their work, RedRouter's token-saving features wouldn't exist. ⭐ them on GitHub!
