...
Published `reddb-io/red-router:*` images are built for the domain root. You can still
...
| --------------------- | -------- | ------ | ---------------------------------------------------- |
| `reddb-io/red-router` | `latest` | ~250MB | Highest **published** stable SemVer (not git `main`) |
| `reddb-io/red-router` | `3.8.0`  | ~250MB | Pin this class of tag for GitOps                     |
