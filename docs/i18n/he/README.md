...
![משיכות Docker](https://img.shields.io/docker/pulls/reddb-io/red-router?label=docker%20pulls&logo=docker&color=2496ED)
...
<table>
  ...
  <tr><td align="left" nowrap>🐳 <b>Docker</b></td><td align="left" nowrap><code>docker run … reddb-io/red-router</code></td><td align="left">תמיכה בריבוי ארכיטקטורות <b>AMD64 + ARM64</b></td></tr>
...
> **ערוץ קדם-הפצה של Docker:** התגיות `reddb-io/red-router:next` ו-
> `reddb-io/red-router:next-web` עוקבות אחר ענף ברירת המחדל הנוכחי `release/v*`.
...
<table>
  ...
  <tr><td nowrap><b>קישורים</b></td><td><a href="https://omniroute.online">אתר אינטרנט</a> · <a href="https://www.npmjs.com/package/omniroute">npm</a> · <a href="https://hub.docker.com/r/reddb-io/red-router">Docker Hub</a></td></tr>
</table>
