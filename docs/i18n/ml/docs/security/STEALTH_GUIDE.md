...
- പ്രോക്സി പരിഹാരം (മുൻഗണന): `HTTPS_PROXY` → `HTTP_PROXY` → `ALL_PROXY` (ലോവർകേസ് രൂപങ്ങളും)
...
### `claudeCodeCompatible.ts` — `anthropic-compatible-cc-*` പ്രൊവൈഡറുകൾ
...
3. Antigravity പ്രൊവൈഡറുടെ എഡിറ്റ് പേജിൽ **ഓരോ കണക്ഷനുമുള്ള RPM പരിധികൾ സജ്ജമാക്കുക** (Dashboard → Providers → Antigravity → connection → rate limit). തുടർച്ചയായ ഉപയോഗത്തിന് 30–60 RPM ന്യായീകരിക്കാവുന്ന പരമാവധി പരിധിയാണ്.
...
- `open-sse/executors/antigravity.ts` — `process.env.ANTIGRAVITY_CREDITS` വായിക്കുന്നു
- `src/lib/oauth/providers/antigravity.ts` — ക്രെഡൻഷ്യൽ പ്ലംബിംഗ്
- യഥാർത്ഥ സംഭവ റിപ്പോർട്ട്: Discussion [#1183](https://github.com/diegosouzapw/OmniRoute/discussions/1183)
...
- [RESILIENCE_GUIDE.md](../architecture/RESILIENCE_GUIDE.md) — ഒരു സ്റ്റെൽത്ത് പാത്തിന് `403` ലഭിക്കുമ്പോൾ എന്ത് സംഭവിക്കുന്നു
- [TROUBLESHOOTING.md](../guides/TROUBLESHOOTING.md)
- [ENVIRONMENT.md](../reference/ENVIRONMENT.md) — പരിസ്ഥിതി വേരിയബിളുകളുടെ സമ്പൂർണ്ണ റഫറൻസ്
- [CLI-TOOLS.md](../reference/CLI-TOOLS.md) — MITM വർക്ക്ഫ്ലോയുടെ ഓപ്പറേറ്റർ കാഴ്ചപ്പാട്
