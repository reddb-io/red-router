...
റെപ്പോസിറ്ററിയിൽ ഒരു മൾട്ടി-സ്റ്റേജ് Dockerfile (`Dockerfile`) ഉൾപ്പെടുത്തിയിരിക്കുന്നു. നാല് ഘട്ടങ്ങൾ ലഭ്യമാണ്; നിങ്ങളുടെ ഉപയോഗ സാഹചര്യത്തിന് അനുയോജ്യമായ `target` തിരഞ്ഞെടുക്കുക.

| ഘട്ടം         | അടിസ്ഥാന ഇമേജ്        | ഉദ്ദേശ്യം                                                                                                                                                                                                                                                                                                                     |
| ------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `builder`     | `node:26-trixie-slim` | ഡിപെൻഡൻസികൾ ഇൻസ്റ്റാൾ ചെയ്യുകയും (`npm ci --legacy-peer-deps`) `npm run build` പ്രവർത്തിപ്പിക്കുകയും ചെയ്യുന്നു (സ്ഥിരസ്ഥിതിയായി Turbopack — താഴെയുള്ള ബിൽഡ്-സമയ വിഭവങ്ങൾ കാണുക)                                                                                                                                              |
| `runner-base` | `node:26-trixie-slim` | Next.js സ്റ്റാൻഡ്എലോൺ ഔട്ട്പുട്ടോടുകൂടിയ പ്രൊഡക്ഷൻ റൺടൈം. **പ്രൊവൈഡർ CLI-കളൊന്നും ഉൾപ്പെടുത്തിയിട്ടില്ല.**                                                                                                                                                                                                                    |
...
| `runner-web`  | `runner-base`         | വെബ്-സെഷൻ പ്രൊവൈഡർമാരായ `gemini-web`, `claude-web`, `claude-turnstile` എന്നിവയ്ക്കായി Playwright-ഉം ഒരു Chromium ബ്രൗസറും (`--with-deps`) ചേർക്കുന്നു. **ആ പ്രൊവൈഡറുകൾ ഉപയോഗിക്കുമ്പോൾ ഇത് തിരഞ്ഞെടുക്കുക** — ഇതില്ലെങ്കിൽ സാധാരണ ഇമേജ് അഭ്യർത്ഥനാ സമയത്ത് പരാജയപ്പെടും (റിലീസ് ചാനലുകൾക്ക് കീഴിലുള്ള `-web` കുറിപ്പ് കാണുക). |

ഒരു നിർദ്ദിഷ്ട ടാർഗറ്റ് മാനുവലായി ബിൽഡ് ചെയ്യുക:
...
`builder` ഘട്ടത്തിന് എത്ര വിഭവങ്ങൾ ആവശ്യമായി വരുമെന്ന് മൂന്ന് ബിൽഡ് ആർഗ്യുമെന്റുകൾ നിയന്ത്രിക്കുന്നു. അവ ബിൽഡ് സമയത്ത് മാത്രമുള്ളവയാണ് —
`OMNIROUTE_MEMORY_MB` (താഴെ) വേറിട്ട ഒരു റൺടൈം ക്രമീകരണമാണ്.

| ബിൽഡ് ആർഗ്യുമെന്റ്          | സ്ഥിരസ്ഥിതി | പ്രഭാവം                                                                                                          |
| --------------------------- | ----------- | ---------------------------------------------------------------------------------------------------------------- |
| `OMNIROUTE_USE_TURBOPACK`   | `1`         | `0` ആണെങ്കിൽ പകരം webpack ഉപയോഗിച്ച് ബിൽഡ് ചെയ്യുന്നു. പീക്ക് മെമ്മറി കുറവായിരിക്കും, എന്നാൽ വേഗതയും കുറയും.     |
| `OMNIROUTE_BUILD_MEMORY_MB` | `6144`      | സൃഷ്ടിക്കപ്പെടുന്ന `next build`-നുള്ള V8 ഹീപ്പ് പരിധി (`--max-old-space-size`).                                  |
| `OMNIROUTE_BUILD_WORKERS`   | `2`         | `CIRCLE_NODE_TOTAL`-ന് മൂല്യം നൽകുന്നു; പേജ്-ഡാറ്റ ശേഖരണത്തിനായി Next `workers = N - 1` എന്നത് നിർണ്ണയിക്കുന്നു. |

വലിയൊരു ബിൽഡറിൽ വർധിപ്പിക്കേണ്ടതും, പരിമിത വിഭവങ്ങളുള്ള ബിൽഡ് `✓ Compiled successfully` എന്നതിന് **ശേഷം** പരാജയപ്പെടുമ്പോൾ സംശയിക്കേണ്ടതുമായ ക്രമീകരണം `OMNIROUTE_BUILD_WORKERS` ആണ്. ഓരോ
പേജ്-ഡാറ്റ വർക്കറും ഒരു പ്രത്യേക പ്രോസസാണ്; പാരന്റ് `next build` തന്നെയും
ഒരു പ്രത്യേക പ്രോസസാണ്. ഒരു തത്സമയ VPS പുനരാവിഷ്കരണത്തിൽ (ഇഷ്യൂ #7518), `NODE_OPTIONS`
ഹീപ്പ് ഫ്ലാഗിൽനിന്ന് സ്വതന്ത്രമായി ഓരോ പ്രോസസിന്റെയും പീക്ക് RSS ഏകദേശം
~4.5 GB ആയി അളന്നു (Turbopack, V8 ഹീപ്പിന് പുറത്തുള്ള നേറ്റീവ്/Rust മെമ്മറിയിലാണ്
കംപൈൽ ചെയ്യുന്നത്). സ്ഥിരസ്ഥിതിയായ `2` (→ 1 വർക്കർ, ആകെ 2
പ്രോസസുകൾ) പ്രസിദ്ധീകരണ പൈപ്പ്ലൈൻ ഉപയോഗിക്കുന്ന 16 GB / 4 vCPU GitHub-ഹോസ്റ്റഡ്
റണ്ണറുകൾക്ക് അനുയോജ്യമായാണ് ക്രമീകരിച്ചിരിക്കുന്നത്. `8`-ൽ (→ 7 വർക്കറുകൾ) ആ റണ്ണറിന്റെ മെമ്മറി തീരുകയും
buildkit `ResourceExhausted: ... cannot allocate memory` എന്ന പിശകോടെ
ആ ഘട്ടം പരാജയപ്പെടുത്തുകയും ചെയ്തു; ഓരോ പ്രോസസിന്റെയും RSS അനുമാനിക്കുന്നതിന് പകരം
നേരിട്ട് അളന്നപ്പോൾ `3` (→ 2 വർക്കറുകൾ) പോലും ഉൾക്കൊള്ളാനായില്ല.
`tests/unit/docker-build-memory-budget.test.ts` അളന്ന കണക്കിനെ അടിസ്ഥാനമാക്കി
ഗണിതം ചെയ്യുകയും, ഏതെങ്കിലും ക്രമീകരണം റണ്ണറിന്റെ പരിധി കവിഞ്ഞാൽ പരാജയപ്പെടുകയും ചെയ്യുന്നു.

Turbopack, V8 ഹീപ്പിന് **പുറത്തുള്ള** നേറ്റീവ് Rust മെമ്മറിയിലാണ് കംപൈൽ ചെയ്യുന്നത്, അതിനാൽ
`OMNIROUTE_BUILD_MEMORY_MB` അതിനെ പരിമിതപ്പെടുത്തുന്നില്ല. മെമ്മറി പരിധിയുള്ള ഒരു ഹോസ്റ്റിൽ,
OOM കില്ലർ ഒരു പിശക് സന്ദേശവും നൽകാതെ ബിൽഡിനെ SIGKILL ചെയ്യും — അത്
`Creating an optimized production build` എന്നതിന്റെ മധ്യത്തിൽ നിർത്തപ്പെടും; അതിനാൽ
മെമ്മറി തീർന്നതായി തോന്നുന്നതിന് പകരം ബിൽഡ് സ്തംഭിച്ചതുപോലെ തോന്നും. ബിൽഡ് ഹോസ്റ്റിന്
പരിമിത വിഭവങ്ങളാണെങ്കിൽ, ബണ്ട്ലർ മാറ്റുക:
...
`webpackBuildWorker` പ്രവർത്തനക്ഷമമാക്കിയിരിക്കുന്നതിനാൽ, `next build` ഒരു പാരന്റ്
പ്രോസസും ഒരു വർക്കർ പ്രോസസും പ്രവർത്തിപ്പിക്കുന്നു; ഓരോന്നും `OMNIROUTE_BUILD_MEMORY_MB`
വെവ്വേറെ മാനിക്കുന്നു. കണ്ടെയ്നറിന്റെ പരിധി ഈ മൂല്യത്തിന്റെ ഏകദേശം ഇരട്ടിയേക്കാൾ കൂടുതലായി
ക്രമീകരിക്കുക, ഒരിരട്ടിയല്ല.

ഈ ട്രീയിൽ അളന്നത് (`--target runner-base`, `OMNIROUTE_BUILD_MEMORY_MB=6144`):

| ബണ്ട്ലർ   | കണ്ടെയ്നർ പരിധി | ഫലം                                  |
| --------- | --------------- | ------------------------------------ |
| Turbopack | 8 GiB / 16 GiB  | രണ്ടിലും നിശ്ശബ്ദമായി OOM-killed ആയി |
| webpack   | 8 GiB           | ബിൽഡ് വർക്കർ SIGKILLed ആയി           |
| webpack   | 12 GiB          | വിജയിച്ചു, പീക്ക് 11.1 GiB ആയിരുന്നു |

### റൺടൈം സ്ഥിരസ്ഥിതികൾ

`runner-base` എക്സ്പോർട്ട് ചെയ്യുന്ന സ്ഥിരസ്ഥിതികൾ: `PORT=20128`, `HOSTNAME=0.0.0.0`, `OMNIROUTE_MEMORY_MB=1024`, `NODE_OPTIONS=--max-old-space-size=1024`, `DATA_DIR=/app/data`, `OMNIROUTE_MIGRATIONS_DIR=/app/migrations`.

Docker-ലെ മെമ്മറി പെരുമാറ്റം:

- ഇമേജ് `OMNIROUTE_MEMORY_MB=1024` സജ്ജീകരിക്കുകയും അതിൽനിന്ന് `NODE_OPTIONS=--max-old-space-size=1024` നിർണ്ണയിക്കുകയും ചെയ്യുന്നു.
- യഥാർത്ഥ സെർവർ പ്രോസസ് standalone launcher ആണ് ആരംഭിക്കുന്നത്; അത് `OMNIROUTE_MEMORY_MB` വായിച്ച് `--max-old-space-size=<OMNIROUTE_MEMORY_MB>` ചേർക്കുന്നു.
- ആവർത്തിച്ചുള്ള `--max-old-space-size` മൂല്യങ്ങളിൽ അവസാനത്തേതാണ് Node ഉപയോഗിക്കുന്നത്, അതിനാൽ `OMNIROUTE_MEMORY_MB` സജ്ജീകരിക്കുന്നത് പ്രാബല്യത്തിലുള്ള Docker heap പരിധിയെ നിയന്ത്രിക്കുന്നു.
- ഇമേജ് ഇത് എല്ലായ്പ്പോഴും സജ്ജീകരിക്കുന്നതിനാൽ, launcher's സ്വന്തം RAM-അനുസരിച്ച് ക്രമീകരിച്ച fallback Docker-ൽ ഒരിക്കലും പ്രയോഗിക്കപ്പെടുന്നില്ല. workload-ന് അനുയോജ്യമായി ഇത് വ്യക്തമായി ഉയർത്തുക (താഴെയുള്ള പട്ടിക കാണുക). coding-agent `/v1/responses`-ന് `2048` ഇപ്പോഴും വളരെ കുറവാണ്.

### coding agents-നുള്ള runtime RAM

1 GiB Docker default എന്നത് dashboard/light-chat-നുള്ള ഏറ്റവും കുറഞ്ഞ പരിധിയാണ്, production വലുപ്പമല്ല. ദൈർഘ്യമേറിയ `POST /v1/responses` bodies (നൂറുകണക്കിന് messages, പതിനക്കണക്കിന് tools) compression സമയത്ത് ഒന്നിലധികം in-memory graphs നിലനിർത്തുന്നു. പരസ്പരം overlap ചെയ്യുന്ന ~3 MiB / ~750k-token വലുപ്പമുള്ള രണ്ട് requests, **12 GiB** old-space-ൽ V8 നിർത്തലാക്കുന്നതിന് (`FATAL ERROR: Reached heap limit`) കാരണമായിട്ടുണ്ട്; കൂടാതെ 16 GiB cgroup OOM-ലും എത്തിയിട്ടുണ്ട്. [#7849](https://github.com/diegosouzapw/OmniRoute/issues/7849) കാണുക.

**heap-നേക്കാൾ ഉയർന്ന cgroup `--memory` ക്രമീകരിക്കുക** — native buffers, SQLite, compression intermediates എന്നിവ V8-ന് പുറത്താണ് നിലനിൽക്കുന്നത്.

| Workload                                                | `OMNIROUTE_MEMORY_MB`      | Container / cgroup             | കുറിപ്പുകൾ                                                                                                                                 |
| ------------------------------------------------------- | -------------------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Dashboard, ഒരു light chat                               | `1024` (image default)     | ≥2 GiB                         |                                                                                                                                            |
| ഒരു coding agent (Claude/Codex/Grok)                    | `8192`                     | ≥10 GiB                        | സാധാരണ single-session `/v1/responses`                                                                                                      |
| ഒരേസമയം രണ്ട് ദൈർഘ്യമേറിയ `/v1/responses`               | `10240`–`12288`            | ≥12–16 GiB                     | ~12 GiB heap-ൽ V8 നിർത്തലാക്കൽ രേഖപ്പെടുത്തിയിട്ടുണ്ട്                                                                                     |
| ഒരേസമയം മൂന്ന് അല്ലെങ്കിൽ അതിലധികം ദൈർഘ്യമേറിയ contexts | ഒരൊറ്റ process-ൽ ചെയ്യരുത് | serialize ചെയ്യുക / കൂടുതൽ RAM | default heavyweight admission-ൽ ഒരേസമയം 1 request മാത്രമേ പ്രവർത്തിക്കൂ; അധിക RAM ഇല്ലാതെ അത് ഉയർത്തുന്നത് നിർത്തലാക്കൽ വീണ്ടും ഉണ്ടാക്കും |

`OMNIROUTE_MEMORY_MB` **സജ്ജീകരിക്കാത്തപ്പോൾ**, bare metal-ലെ `omniroute serve` RAM-ന്റെ ~35% അനുസരിച്ച് ക്രമീകരിക്കുന്നു (`[512, 4096]` പരിധിക്കുള്ളിൽ). Docker എല്ലായ്പ്പോഴും `1024` സജ്ജീകരിക്കുന്നതിനാൽ, ഔദ്യോഗിക image-ൽ ഈ ക്രമീകരണം ഒരിക്കലും പ്രവർത്തിക്കില്ല.
