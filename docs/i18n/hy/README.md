...
![Docker ներբեռնումներ](https://img.shields.io/docker/pulls/reddb-io/red-router?label=docker%20pulls&logo=docker&color=2496ED)
...
<table>
  ...
  <tr><td align="left" nowrap>🐳 <b>Docker</b></td><td align="left" nowrap><code>docker run … reddb-io/red-router</code></td><td align="left">Բազմաճարտարապետական՝ <b>AMD64 + ARM64</b></td></tr>
...
> **Docker-ի նախաթողարկման ալիք.** `reddb-io/red-router:next` և
> `reddb-io/red-router:next-web` թեգերը հետևում են ընթացիկ լռելյայն `release/v*`
...
<table>
  ...
  <tr><td nowrap><b>Հղումներ</b></td><td><a href="https://omniroute.online">Կայք</a> · <a href="https://www.npmjs.com/package/omniroute">npm</a> · <a href="https://hub.docker.com/r/reddb-io/red-router">Docker Hub</a></td></tr>
</table>
