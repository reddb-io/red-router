...
Objavljene slike `reddb-io/red-router:*` izgrađene su za korijen domene. I dalje
...
| --------------------- | -------- | -------- | ------------------------------------------------------ |
| `reddb-io/red-router` | `latest` | ~250MB   | Najviši **objavljeni** stabilni SemVer (ne git `main`) |
