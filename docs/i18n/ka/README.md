...
<table>
  ...
  <tr><td nowrap><b>ენა</b></td><td>TypeScript 6.0 — <b>100% TypeScript</b> `src/`-სა და `open-sse/`-ში (ნულოვანი `any` ძირითად ნაწილში v2.0-დან)</td></tr>
  <tr><td nowrap><b>ფრეიმვორკი</b></td><td>Next.js 16 + React 19 + Tailwind CSS 4</td></tr>
  <tr><td nowrap><b>მონაცემთა ბაზა</b></td><td>better-sqlite3 (SQLite, WAL journaling) + LowDB (JSON legacy) — 122 დომენის მოდული, 183 მიგრაცია</td></tr>
  <tr><td nowrap><b>მეხსიერება</b></td><td>SQLite FTS5 სრული ტექსტი + int8-კვანტიზებული ვექტორული ჩანერგვები, ტიპური დაშლა</td></tr>
  ...
  <tr><td nowrap><b>სტელსი</b></td><td>wreq-js — JA3 / JA4 TLS თითის ანაბეჭდის იმიტაცია, 3-დონიანი პროქსი</td></tr>
  <tr><td nowrap><b>მდგრადობა</b></td><td>წრედის ამომრთველი, ექსპონენციური უკუდახევა, "anti-thundering-herd", ავტო-კომბო თვითაღდგენა</td></tr>
