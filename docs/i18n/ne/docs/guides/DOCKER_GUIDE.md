...
# होस्ट प्रोफाइल (Linux-प्राथमिक; होस्टका CLI बाइनरीहरू पढ्न-मात्र मिल्ने गरी माउन्ट गर्छ)
...
OmniRoute मुख्य डिप्लोयमेन्ट प्रकारहरूका लागि Compose प्रोफाइलहरूसहित उपलब्ध हुन्छ। तपाईंको वातावरणसँग मेल खाने प्रोफाइल छान्नुहोस्।

| प्रोफाइल                | सेवा             | कहिले प्रयोग गर्ने                                                                                                                            | कमाण्ड                                       |
| ----------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| `base` (पूर्वनिर्धारित) | `omniroute-base` | हेडलेस सर्भर / न्यूनतम रनटाइम, कुनै पनि प्रदायक CLI समावेश नगरिएको                                                                            | `docker compose --profile base up -d`        |
...
| `host`                  | `omniroute-host` | `~/.local/bin`, `~/.codex`, `~/.claude`, आदि केवल पढ्न मिल्ने गरी माउन्ट गरेर होस्ट CLI हरूमा `network_mode`-जस्तै पहुँच चाहने Linux होस्टहरू | `docker compose --profile host up -d`        |
...
## महत्त्वपूर्ण वातावरण चरहरू

[ENVIRONMENT.md](../reference/ENVIRONMENT.md) मा दस्तावेजीकरण गरिएका पूर्वनिर्धारित मानहरूका अतिरिक्त, Docker अन्तर्गत चलाउँदा निम्न चरहरू सबैभन्दा महत्त्वपूर्ण हुन्छन्:

| चर                            | उद्देश्य                                                                                                                                                                                                                                                                                    | पूर्वनिर्धारित मान             |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| `OMNIROUTE_WS_BRIDGE_SECRET`  | WebSocket ब्रिजका लागि साझा गोप्य मान। **उत्पादनमा आवश्यक** — यसलाई बलियो अनियमित स्ट्रिङमा सेट गर्नुहोस्।                                                                                                                                                                                  | सेट नगरिएको (प्रदान गर्नुपर्छ) |
...
| `REDIS_BIND_HOST`             | समावेश गरिएको Redis पोर्ट प्रकाशित हुने होस्ट इन्टरफेस (तपाईंले AUTH थप्नुभएन भने लुपब्याक)                                                                                                                                                                                                 | `127.0.0.1`                    |
| `AUTO_UPDATE_HOST_REPO_DIR`   | स्व-अद्यावधिक कार्यप्रवाहहरूका लागि `/workspace/omniroute` मा `cli` प्रोफाइलभित्र माउन्ट गरिएको होस्ट पथ                                                                                                                                                                                    | `.` (हालको डाइरेक्टरी)         |
| `OMNIROUTE_MEMORY_MB`         | Docker स्ट्यान्डअलोन सर्भरका लागि रनटाइम Node हिप सीमा; माथिको इमेजको पूर्वनिर्धारित मानलाई अधिलेखन गर्छ। कोडिङ एजेन्टहरू: `8192`+ ([रनटाइम RAM](#runtime-ram-for-coding-agents) हेर्नुहोस्)।                                                                                               | `1024`                         |
| `DASHBOARD_PORT` / `API_PORT` | ड्यासबोर्ड (20128) र API (20129) का लागि सार्वजनिक गरिएका पोर्टहरू अधिलेखन गर्नुहोस्                                                                                                                                                                                                        | `20128` / `20129`              |
| `APP_BIND_HOST`               | docker-compose ले ड्यासबोर्ड/API/live-WS पोर्टहरू प्रकाशित गर्ने होस्ट इन्टरफेस। `REQUIRE_API_KEY=false` (पूर्वनिर्धारित) हुँदा, `0.0.0.0` ले अज्ञात `/v1` प्रोक्सीलाई LAN मा सार्वजनिक गर्छ — `REQUIRE_API_KEY=true` हुँदा वा अगाडि रिभर्स प्रोक्सी भएको अवस्थामा मात्र विस्तार गर्नुहोस्। | `127.0.0.1`                    |
| `CLIPROXY_BIND_HOST`          | docker-compose ले `cliproxyapi` साइडकार प्रकाशित गर्ने होस्ट इन्टरफेस — यसको डेटा भोल्युममा प्रदायकका प्रमाणपत्रहरू भण्डारण हुन्छन्।                                                                                                                                                        | `127.0.0.1`                    |
| `OMNIROUTE_PLUGINS_DIR`       | रनटाइम प्लगइन स्क्यानरले पढ्ने र स्थापना गर्ने डाइरेक्टरी। प्लगइनहरू बाइन्ड-माउन्ट गरिएका हुँदा यसलाई सेट गर्नुहोस्: पूर्वनिर्धारित मानले `HOME` पछ्याउँछ, जुन इमेजले निर्यात नगरेको हुन सक्छ।                                                                                              | `~/.omniroute/plugins`         |
| `OMNIROUTE_BASE_PATH`         | एप रिभर्स प्रोक्सीपछाडि प्रकाशित हुँदा प्रयोग हुने URL उपपथ (जस्तै `/omniroute`)                                                                                                                                                                                                            | _(खाली = रुट)_                 |
| `NEXT_PUBLIC_BASE_URL`        | उपपथसहितको सार्वजनिक ब्राउजर मूल ठेगाना (जस्तै `https://host/omniroute`)                                                                                                                                                                                                                    | सेट नगरिएको                    |
...
प्रकाशित `reddb-io/red-router:*` इमेजहरू डोमेन रुटका लागि बिल्ड गरिएका हुन्छन्। तपाईंले अझै पनि रनटाइममा `OMNIROUTE_BASE_PATH` सेट गर्न सक्नुहुन्छ; कन्टेनरले स्टार्टअपमा एकपटक बन्डल प्याच गर्छ। यसलाई मिल्दो सार्वजनिक ओरिजिनसँग प्रयोग गर्नुहोस्:
...
| --------------------- | -------- | ------ | --------------------------------------------------------- |
| `reddb-io/red-router` | `latest` | ~250MB | सबैभन्दा उच्च **प्रकाशित** स्थिर SemVer (git `main` होइन) |
| `reddb-io/red-router` | `3.8.0`  | ~250MB | GitOps का लागि यस प्रकारको ट्याग पिन गर्नुहोस्            |

बहु-प्लेटफर्म म्यानिफेस्ट: `linux/amd64` + `linux/arm64` नेटिभ (Apple Silicon, AWS Graviton, Raspberry Pi)। Docker ले मिल्दो आर्किटेक्चर स्वचालित रूपमा चयन गर्छ; ARM होस्टहरूमा AMD64 इमुलेसन जबर्जस्ती प्रयोग गर्न आवश्यक भए `--platform linux/amd64` पास गर्नुहोस्।
...
| ------------------------------- | ----------------------------------------- | ------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `:<version>` / `:<version>-web` | हस्ताक्षरित/संस्करणयुक्त रिलिज            | अपरिवर्तनीय                     | सटीक रिलिज पिन गर्ने उत्पादन डिप्लोयमेन्टहरू                                                          |
| `:latest` / `:latest-web`       | सबैभन्दा उच्च **प्रकाशित** स्थिर SemVer   | परिवर्तनशील स्थिर पोइन्टर       | SemVer प्रकाशन कार्यपछि स्थिर रिलिजहरू पछ्याउँछ — `main` वा अप्रकाशित `release/v*` कमिटहरू पछ्याउँदैन |
| `:next` / `:next-web`           | हालको पूर्वनिर्धारित `release/v*` ब्रान्च | परिवर्तनशील पूर्व-रिलिज पोइन्टर | सक्रिय रिलिज ब्रान्चमा समावेश भइसकेका तर स्थिर रिलिजमा अझै नपरेका सुधारहरूको परीक्षण                  |
| `:main` / `:main-web`           | `main` ब्रान्च                            | परिवर्तनशील विकास पोइन्टर       | विकास र एकीकरण परीक्षणका लागि मात्र                                                                   |

#### वेब-सेसन प्रदायकहरू: `-web` इमेजहरू

माथिको प्रत्येक च्यानलको `-web` ट्याग पनि हुन्छ (`:latest-web`, `:<version>-web`, `:next-web`, `:main-web`), जुन `runner-web` चरणबाट बनाइन्छ — उही इमेजमा Playwright र Chromium ब्राउजर थपिएको हुन्छ। साधारण इमेज Chromium **बिना** उपलब्ध हुन्छ; `gemini-web`, `claude-web` र `claude-turnstile` लाई यसको आवश्यकता पर्छ।

विफलता स्टार्टअपको समयमा नभई पछि देखिन्छ: ती प्रदायकहरूले आफ्ना मोडेलहरू सूचीबद्ध गर्छन् र ड्यासबोर्डमा जडित देखिन्छन्, र पहिलो अनुरोध मात्र निम्न त्रुटिसहित विफल हुन्छ

```
[500]: बाह्य मोड्युल playwright लोड गर्न असफल: त्रुटि: मोड्युल फेला पार्न सकिएन
'/app/node_modules/playwright/node_modules/playwright-core/browsers.json'
```

यदि तपाईं ती प्रदायकहरू प्रयोग गर्नुहुन्छ भने, तपाईंले हाल प्रयोग गरिरहनुभएको च्यानलको `-web` ट्याग पुल गर्नुहोस् — अरू केही परिवर्तन हुँदैन। npm/CLI स्थापना (Docker इमेजबिना) मा, छुटेको समकक्ष भाग ब्राउजर बाइनरी हो: होस्टमा `npx playwright install chromium` चलाउनुहोस्।

#### पूर्व-रिलिज च्यानल प्रयोग गर्ने

हालको पूर्वनिर्धारित `release/v*` ब्रान्चमा प्रत्येक पुश हुँदा `next` च्यानल पुनः निर्माण हुन्छ र AMD64 तथा ARM64 दुवैका लागि प्रकाशित हुन्छ। पुराना मर्मतसम्भार ब्रान्चहरूले यसलाई अधिलेखन गर्न सक्दैनन्। यस च्यानलले अर्को स्थिर ट्याग बनाइनुअघि सक्रिय रिलिज ब्रान्चमा मर्ज भएका सुधारहरूका लागि पुल गर्न मिल्ने इमेज प्रदान गर्छ।
...
Docker Compose का लागि, चयन गरिएको प्रोफाइलले प्रयोग गर्ने इमेज ट्याग अधिलेखन गर्नुहोस्, त्यसपछि सेवा पुल गरी पुनः सिर्जना गर्नुहोस्:
...
`next` एक परिवर्तनशील पूर्व-रिलिज च्यानल हो। सक्रिय रिलिज ब्रान्चमा कुनै पनि पुश हुँदा यो परिवर्तन हुन सक्छ र यो **उत्पादन प्रयोगका लागि समर्थित छैन**। कुनै निश्चित बिल्डको मूल्याङ्कन गर्दा इमेज डाइजेस्ट पिन गर्नुहोस्:
...
परीक्षण गर्नुअघि OmniRoute डेटा भोल्युम वा बाइन्ड-माउन्ट गरिएको डेटा डाइरेक्टरीको ब्याकअप लिनुहोस्। रोलब्याक गर्न, पहिले प्रयोग गरिएको स्थिर संस्करण वा डाइजेस्ट पुनर्स्थापना गर्नुहोस् र कन्टेनर पुनः सिर्जना गर्नुहोस्:
...
रिलिज-ब्रान्च बिल्डले कहिल्यै `latest` सार्न सक्दैन; योग्य स्थिर सिम्यान्टिक संस्करणले मात्र स्थिर पोइन्टर प्रवर्द्धन गर्न सक्छ। `next` इमेजहरूले रिलिज इमेजको निरीक्षण र ब्लक गर्ने CRITICAL-दुर्बलता गेट कायम राख्छन्।

**`latest` git को नवीनताको ग्यारेन्टी होइन।** `main` वा सक्रिय `release/v*` ब्रान्चमा मर्ज गरिएका सुधारहरू स्थिर SemVer इमेज प्रकाशित नभएसम्म र प्रकाशन कार्यले `:latest` लाई प्रवर्द्धन नगरेसम्म `:latest` मा समावेश हुँदैनन् (त्यो SemVer कै समान डाइजेस्ट)। GitHub मा सुधार देखिइसकेको भए पनि `latest` स्थिर देखिन्छ भने, रिलिज ब्रान्च परीक्षण गर्न `:next` पुल गर्नुहोस् वा SemVer ट्यागको प्रतीक्षा गर्नुहोस्।

| तपाईं के चाहनुहुन्छ                                                            | प्रयोग गर्नुहोस्                          |
| ------------------------------------------------------------------------------ | ----------------------------------------- |
| परिवर्तन हुन नहुने GitOps / उत्पादन                                            | `:X.Y.Z` (वा इमेज डाइजेस्ट) पिन गर्नुहोस् |
| प्रकाशित स्थिर रिलिजहरू पछ्याउने र प्रत्येक रिलिजमा पुनः सिर्जना स्वीकार गर्ने | `:latest`                                 |
| अप्रकाशित `release/v*` कमिटहरू परीक्षण गर्ने                                   | `:next` (उत्पादनका लागि होइन)             |
