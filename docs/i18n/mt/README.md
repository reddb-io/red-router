...
![Tniżżiliet minn Docker](https://img.shields.io/docker/pulls/reddb-io/red-router?label=docker%20pulls&logo=docker&color=2496ED)
...
> **Kanal ta’ Docker għall-verżjonijiet preliminari:** `reddb-io/red-router:next` u
> `reddb-io/red-router:next-web` isegwu l-fergħa default attwali `release/v*`.
...
<table>
  ...
  <tr><td nowrap><b>Rabtiet</b></td><td><a href="https://omniroute.online">Websajt</a> · <a href="https://www.npmjs.com/package/omniroute">npm</a> · <a href="https://hub.docker.com/r/reddb-io/red-router">Docker Hub</a></td></tr>
</table>
