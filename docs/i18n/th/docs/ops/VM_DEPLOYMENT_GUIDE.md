...
> **เคล็ดลับ**: เพื่อความปลอดภัยสูงสุด ให้จำกัดพอร์ต 80 และ 443 เฉพาะ IP ของ Cloudflare เท่านั้น ดูส่วน[ความปลอดภัยขั้นสูง](#advanced-security)
...
ดูคำแนะนำทีละขั้นตอนเกี่ยวกับ Cloudflare Tunnel ภายในที่เก็บโค้ดเพิ่มเติมได้ที่ [TUNNELS_GUIDE.md](./TUNNELS_GUIDE.md) โดย Worker แบบสแตนด์อโลนใน `omnirouteCloud/` อยู่ในที่เก็บโค้ดประกอบแยกต่างหาก
