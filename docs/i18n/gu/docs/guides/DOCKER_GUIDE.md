...
# હોસ્ટ પ્રોફાઇલ (Linux-પ્રથમ; હોસ્ટ CLI બાઇનરીઝને ફક્ત વાંચવા માટે માઉન્ટ કરે છે)
docker compose --profile host up -d

# વેબ પ્રોફાઇલ (વેબ-સેશન પ્રદાતાઓ માટે Chromium/Playwright)
...
OmniRoute મુખ્ય ડિપ્લોયમેન્ટ પ્રકારો માટે Compose પ્રોફાઇલ્સ સાથે આવે છે. તમારા પર્યાવરણને અનુરૂપ પ્રોફાઇલ પસંદ કરો.
...
| `cli`            | `omniroute-cli`  | `omniroute providers/setup/doctor` અને સામેલ કરેલ CLI (Codex, Claude Code, Droid, OpenClaw)ને કૉલ કરતા એજન્ટિક વર્કફ્લો                     | `docker compose --profile cli up -d`         |
| `host`           | `omniroute-host` | `~/.local/bin`, `~/.codex`, `~/.claude` વગેરેને ફક્ત વાંચવા માટે માઉન્ટ કરીને હોસ્ટ CLI માટે `network_mode` જેવો ઍક્સેસ ઇચ્છતા Linux હોસ્ટ  | `docker compose --profile host up -d`        |
...
| `web`            | `omniroute-web`  | બ્રાઉઝરની જરૂર હોય તેવા વેબ-સેશન પ્રોવાઇડર્સ: `gemini-web`, `claude-web`, `claude-turnstile` (`runner-web` બિલ્ડ કરે છે, Chromium સામેલ છે) | `docker compose --profile web up -d`         |
...
## મહત્વપૂર્ણ એન્વાયર્નમેન્ટ વેરિએબલ્સ
...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `OMNIROUTE_WS_BRIDGE_SECRET`  | WebSocket બ્રિજ માટેનું શેર કરેલું સિક્રેટ. **પ્રોડક્શનમાં આવશ્યક છે** — તેને મજબૂત રેન્ડમ સ્ટ્રિંગ પર સેટ કરો.                                                                                                                                                                     | સેટ કરેલ નથી (પ્રદાન કરવું આવશ્યક છે) |
...
| `DASHBOARD_PORT` / `API_PORT` | ડૅશબોર્ડ (20128) અને API (20129) માટે ખુલ્લા કરાયેલા પોર્ટ્સને ઓવરરાઇડ કરે છે                                                                                                                                                                                                       | `20128` / `20129`                     |
| `APP_BIND_HOST`               | હોસ્ટ ઇન્ટરફેસ કે જેના પર docker-compose ડૅશબોર્ડ/API/live-WS પોર્ટ્સ પ્રકાશિત કરે છે. `REQUIRE_API_KEY=false` (ડિફૉલ્ટ) સાથે, `0.0.0.0` અનામી `/v1` પ્રૉક્સીને LAN માટે ખુલ્લું મૂકે છે — માત્ર `REQUIRE_API_KEY=true` હોય અથવા આગળ રિવર્સ પ્રૉક્સી હોય ત્યારે જ તેનો વ્યાપ વધારો. | `127.0.0.1`                           |
| `CLIPROXY_BIND_HOST`          | હોસ્ટ ઇન્ટરફેસ કે જેના પર docker-compose `cliproxyapi` સાઇડકાર પ્રકાશિત કરે છે — તેનું ડેટા વોલ્યુમ પ્રદાતા ક્રેડેન્શિયલ્સ ધરાવે છે.                                                                                                                                                | `127.0.0.1`                           |
| `OMNIROUTE_PLUGINS_DIR`       | રનટાઇમ પ્લગઇન સ્કૅનર જે ડિરેક્ટરીમાંથી વાંચે છે અને જેમાં ઇન્સ્ટૉલ કરે છે. પ્લગઇન્સ bind-mounted હોય ત્યારે તેને સેટ કરો: ડિફૉલ્ટ `HOME` ને અનુસરે છે, જેને ઇમેજે export કર્યું હોય તે જરૂરી નથી.                                                                                   | `~/.omniroute/plugins`                |
| `OMNIROUTE_BASE_PATH`         | ઍપને રિવર્સ પ્રૉક્સીની પાછળ પ્રકાશિત કરવામાં આવે ત્યારે ઉપયોગમાં લેવાતો URL સબપાથ (દા.ત. `/omniroute`)                                                                                                                                                                              | _(ખાલી = રૂટ)_                        |
...
પ્રકાશિત `reddb-io/red-router:*` ઇમેજ ડોમેન રૂટ માટે બિલ્ડ કરવામાં આવે છે. તમે હજી પણ
...
| ઇમેજ                  | ટૅગ      | કદ     | વર્ણન                                                  |
| --------------------- | -------- | ------ | ------------------------------------------------------ |
| `reddb-io/red-router` | `latest` | ~250MB | સૌથી ઊંચું **પ્રકાશિત** સ્થિર SemVer (git `main` નહીં) |
| `reddb-io/red-router` | `3.8.0`  | ~250MB | GitOps માટે આ પ્રકારનો ટૅગ પિન કરો                     |

મલ્ટિ-પ્લેટફોર્મ મેનિફેસ્ટ: `linux/amd64` + `linux/arm64` નેટિવ (Apple Silicon, AWS Graviton, Raspberry Pi). Docker મેળ ખાતું આર્કિટેક્ચર આપમેળે પસંદ કરે છે; ARM હોસ્ટ પર AMD64 ઇમ્યુલેશન ફરજિયાત કરવું હોય તો `--platform linux/amd64` પાસ કરો.

### રિલીઝ ચેનલો

OmniRoute સ્થિર રિલીઝ, સક્રિય રિલીઝ-બ્રાન્ચ પરીક્ષણ અને ડેવલપમેન્ટ બિલ્ડ્સ માટે અલગ Docker ચેનલો પ્રકાશિત કરે છે.

| ચેનલ                            | સ્રોત                                | પરિવર્તનશીલતા                  | ભલામણ કરેલો ઉપયોગ                                                                                                 |
| ------------------------------- | ------------------------------------ | ------------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| `:<version>` / `:<version>-web` | સહી કરેલી/વર્ઝન કરેલી રિલીઝ          | અપરિવર્તનીય                    | ચોક્કસ રિલીઝને પિન કરતાં પ્રોડક્શન ડિપ્લોયમેન્ટ્સ                                                                 |
| `:latest` / `:latest-web`       | સૌથી ઊંચું **પ્રકાશિત** સ્થિર SemVer | પરિવર્તનશીલ સ્થિર પૉઇન્ટર      | SemVer પ્રકાશન જૉબ **પછી** સ્થિર રિલીઝને અનુસરે છે — `main` અથવા અપ્રકાશિત `release/v*` કમિટ્સને અનુસરતું **નથી** |
| `:next` / `:next-web`           | વર્તમાન ડિફૉલ્ટ `release/v*` બ્રાન્ચ | પરિવર્તનશીલ પ્રી-રિલીઝ પૉઇન્ટર | સક્રિય રિલીઝ બ્રાન્ચમાં આવી ગયેલા, પરંતુ હજુ સ્થિર રિલીઝમાં ન હોય તેવા સુધારાઓનું પરીક્ષણ                         |
| `:main` / `:main-web`           | `main` બ્રાન્ચ                       | પરિવર્તનશીલ ડેવલપમેન્ટ પૉઇન્ટર | માત્ર ડેવલપમેન્ટ અને ઇન્ટિગ્રેશન પરીક્ષણ                                                                          |

#### વેબ-સેશન પ્રોવાઇડર્સ: `-web` ઇમેજો

ઉપરની દરેક ચેનલ `-web` ટૅગ (`:latest-web`, `:<version>-web`, `:next-web`, `:main-web`) તરીકે પણ ઉપલબ્ધ છે, જે `runner-web` સ્ટેજમાંથી બિલ્ડ થાય છે — એ જ ઇમેજ ઉપરાંત Playwright અને Chromium બ્રાઉઝર. સાદી ઇમેજ Chromium **વિના** આવે છે; `gemini-web`, `claude-web` અને `claude-turnstile` ને તેની જરૂર પડે છે.

નિષ્ફળતા સ્ટાર્ટઅપ સમયે નહીં, પરંતુ મુલતવી રહે છે: આ પ્રોવાઇડર્સ તેમના મોડલની સૂચિ દર્શાવે છે અને ડૅશબોર્ડમાં કનેક્ટેડ તરીકે દેખાય છે, અને માત્ર પ્રથમ વિનંતી નીચેની ભૂલ સાથે નિષ્ફળ જાય છે
...
જો તમે આ પ્રોવાઇડર્સનો ઉપયોગ કરો છો, તો તમે હાલમાં જે ચેનલ પર છો તેનો `-web` ટૅગ પુલ કરો — બીજું કશું બદલાતું નથી. npm/CLI ઇન્સ્ટૉલમાં (Docker ઇમેજ વિના), તેની સમકક્ષ ખૂટતી વસ્તુ બ્રાઉઝર બાઇનરી છે: હોસ્ટ પર `npx playwright install chromium` ચલાવો.

#### પ્રી-રિલીઝ ચેનલનો ઉપયોગ

વર્તમાન ડિફૉલ્ટ `release/v*` બ્રાન્ચ પરના દરેક પુશ વખતે `next` ચેનલ ફરીથી બિલ્ડ થાય છે અને AMD64 તથા ARM64 બંને માટે પ્રકાશિત થાય છે. જૂની મેઇન્ટેનન્સ બ્રાન્ચો તેને ઓવરરાઇટ કરી શકતી નથી. આ ચેનલ એવા સુધારાઓ માટે પુલ કરી શકાય તેવી ઇમેજ પૂરી પાડે છે, જે આગામી સ્થિર ટૅગ બનાવવામાં આવે તે પહેલાં સક્રિય રિલીઝ બ્રાન્ચમાં મર્જ થઈ ગયા હોય.
...
Docker Compose માટે, પસંદ કરેલી પ્રોફાઇલ દ્વારા ઉપયોગમાં લેવાતો ઇમેજ ટૅગ ઓવરરાઇડ કરો, પછી સર્વિસને પુલ કરીને ફરીથી બનાવો:
...
`next` એક ફ્લોટિંગ પ્રી-રિલીઝ ચેનલ છે. સક્રિય રિલીઝ બ્રાન્ચ પરના કોઈપણ પુશ સાથે તે બદલાઈ શકે છે અને તે **પ્રોડક્શન ઉપયોગ માટે સમર્થિત નથી**. કોઈ ચોક્કસ બિલ્ડનું મૂલ્યાંકન કરતી વખતે ઇમેજ ડાઇજેસ્ટ પિન કરો:
...
પરીક્ષણ પહેલાં, OmniRoute ડેટા વૉલ્યુમ અથવા બાઇન્ડ-માઉન્ટ કરેલી ડેટા ડિરેક્ટરીનો બૅકઅપ લો. રોલબૅક કરવા માટે, અગાઉ ઉપયોગમાં લેવાયેલું સ્થિર વર્ઝન અથવા ડાઇજેસ્ટ પુનઃસ્થાપિત કરો અને કન્ટેનર ફરીથી બનાવો:
...
રિલીઝ-બ્રાન્ચ બિલ્ડ ક્યારેય `latest` ને ખસેડી શકતું નથી; માત્ર પાત્ર સ્થિર સિમેન્ટિક વર્ઝન જ સ્થિર પૉઇન્ટરને પ્રમોટ કરી શકે છે. `next` ઇમેજો રિલીઝ ઇમેજ ઇન્સ્પેક્શન અને અવરોધક CRITICAL-વલ્નરેબિલિટી ગેટ જાળવી રાખે છે.

**`latest` એ git માટે અદ્યતનતાની ખાતરી નથી.** `main` પર અથવા સક્રિય `release/v*` બ્રાન્ચ પર મર્જ થયેલા સુધારાઓ ત્યાં સુધી `:latest` માં હોતા **નથી**, જ્યાં સુધી સ્થિર SemVer ઇમેજ પ્રકાશિત ન થાય અને પ્રકાશન જૉબ `:latest` ને પ્રમોટ ન કરે (તે SemVer જેવો જ ડાઇજેસ્ટ). જો GitHub પર સુધારો પહેલેથી દેખાતો હોવા છતાં `latest` સ્થિર લાગતું હોય, તો રિલીઝ બ્રાન્ચનું પરીક્ષણ કરવા માટે `:next` પુલ કરો અથવા SemVer ટૅગની રાહ જુઓ.

| તમે શું ઇચ્છો છો                                                         | ઉપયોગ કરો                             |
| ------------------------------------------------------------------------ | ------------------------------------- |
| GitOps / પ્રોડક્શન, જેમાં કોઈ અનિચ્છિત ફેરફાર ન થવો જોઈએ                 | `:X.Y.Z` પિન કરો (અથવા ઇમેજ ડાઇજેસ્ટ) |
| પ્રકાશિત સ્થિર રિલીઝને અનુસરો અને દરેક રિલીઝ પર ફરીથી બનાવવાનું સ્વીકારો | `:latest`                             |
| અપ્રકાશિત `release/v*` કમિટ્સનું પરીક્ષણ કરો                             | `:next` (પ્રોડક્શન માટે નહીં)         |
