...
在本机运行 RedRouter,用于开发和个人使用。

---

## 📦 安装

通过 npm 全局安装 RedRouter:
...
API 端口(25050)和仪表盘端口(3000)在应用中配置。如需修改,你需要改源码或使用支持的环境变量(如果有)。

---

## 🛑 停止服务器

在运行 RedRouter 的终端中按 `Ctrl+C`。
