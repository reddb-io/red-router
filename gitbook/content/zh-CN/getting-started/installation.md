...
- ✅ 任意目录均可运行
- ✅ 命令简单:`red-router`
- ✅ 通过 `npm update -g red-router` 自动更新
...
**发生了什么:**
1. 服务器启动在 `http://localhost:25050`
2. 仪表盘在浏览器中自动打开
3. 数据目录创建在 `~/.red-router`
4. API key 自动生成
