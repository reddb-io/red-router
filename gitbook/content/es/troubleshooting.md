...
Problemas comunes y soluciones al usar RedRouter.
...
1. **Refresh automático (por defecto):**
   RedRouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Problema:** "ECONNREFUSED" o "Cannot connect to localhost:25050".

**Causas:**
- RedRouter no está ejecutándose
- Puerto 25050 bloqueado
...
4. **Usa el endpoint en la nube:**
   ...
   ```
   Endpoint: https://github.com/reddb-io/red-router/v1
   ```
...
1. **Verifica si RedRouter está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep red-router
