...
Preguntas comunes sobre RedRouter.

---

## ¿Qué es RedRouter?

**RedRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**RedRouter usa una estrategia de precios de 3 niveles:**
...
**Sí, RedRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de RedRouter.**
...
**RedRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿RedRouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de RedRouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://github.com/reddb-io/red-router/v1
...
## ¿Puedo auto-hospedar RedRouter?

**¡Sí! RedRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.red-router`)
...
**Sí, RedRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.red-router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de RedRouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/reddb-io/red-router/blob/main/CHANGELOG.md)
- Respalda `~/.red-router` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/reddb-io/red-router/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/reddb-io/red-router/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/red-router.git
   cd red-router
...
Consulta [CONTRIBUTING.md](https://github.com/reddb-io/red-router/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [github.com/reddb-io/red-router/docs](https://github.com/reddb-io/red-router/docs)
