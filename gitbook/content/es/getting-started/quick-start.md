...
Pon en marcha RedRouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
🎉 **El dashboard se abre automáticamente** en `http://localhost:25050`
...
Apunta tu herramienta de codificación a RedRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de red-router]
