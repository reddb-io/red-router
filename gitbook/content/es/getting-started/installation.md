...
Guía detallada de instalación de RedRouter con consejos de solución de problemas.
...
Instala RedRouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `red-router`
- ✅ Auto-actualizaciones con `npm update -g red-router`
...
**Qué sucede:**
1. El servidor inicia en `http://localhost:25050`
2. El dashboard se abre automáticamente en el navegador
3. Se crea el directorio de datos en `~/.red-router`
...
**Ubicación por defecto:** `~/.red-router`
...
```bash
# Encuentra proceso usando el puerto 25050
lsof -i :25050
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/red-router'
```
...
**Problema:** RedRouter usa demasiada RAM
...
```bash
npm install -g pm2
pm2 start red-router --name red-router
pm2 save
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con red-router
```
