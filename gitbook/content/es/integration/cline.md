...
Integra RedRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de RedRouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- RedRouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de RedRouter:

**Para RedRouter local:**
```
http://localhost:25050/v1
```

**Para RedRouter en la nube:**
```
https://github.com/reddb-io/red-router
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de RedRouter
...
3. La key debe comenzar con `sk-red-router-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de RedRouter
...
4. Cline usará RedRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando RedRouter
...
3. Obtén explicaciones potenciadas por IA a través de RedRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará RedRouter para entender el contexto y hacer cambios
...
1. Verifica que RedRouter esté corriendo: `curl http://localhost:25050/health`
2. Verifica que la URL base sea correcta e incluya `/v1`
3. Asegúrate de que ningún firewall esté bloqueando el puerto 25050
...
2. Verifica que tu instancia de RedRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de RedRouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de RedRouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://github.com/reddb-io/red-router`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de RedRouter
...
## Integración con características de RedRouter

### Enrutamiento de modelos

RedRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, RedRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de RedRouter:
