...
Integra RedRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de RedRouter desde el [dashboard](https://github.com/reddb-io/red-router/dashboard)
- RedRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de RedRouter
...
```json
{
  "models": [
    {
      "title": "RedRouter - Claude Opus",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:25050/v1"
    }
  ]
}
```
...
```json
{
  "models": [
    {
      "title": "RedRouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:25050/v1"
    ...
    {
      "title": "RedRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "RedRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "RedRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://github.com/reddb-io/red-router/v1"
```
...
3. Elige tu modelo preferido de RedRouter
...
```json
{
  "models": [
    {
      "title": "RedRouter - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:25050/v1",
...
- Verifica que RedRouter esté corriendo: `curl http://localhost:25050/health`
...
- Selecciona el modelo correcto de RedRouter
...
- Verifica la latencia de red hacia RedRouter
