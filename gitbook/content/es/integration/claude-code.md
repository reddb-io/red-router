...
Integra RedRouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de RedRouter.
...
export ANTHROPIC_BASE_URL="http://localhost:25050/v1"
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de RedRouter:
...
```bash
export ANTHROPIC_BASE_URL="https://github.com/reddb-io/red-router"
```
