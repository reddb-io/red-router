...
RedRouterをOpenAI Codex CLIと統合し、OpenAI APIリクエストをRedRouterのインテリジェントルーティングシステム経由でルーティングします。
...
1. RedRouterダッシュボードでAPIキーが正しいか確認
...
1. モデル名がRedRouter設定と一致するか確認
2. RedRouterダッシュボードでOpenAIプロバイダー接続がアクティブか確認
