...
RedRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをRedRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはRedRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
