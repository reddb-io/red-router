...
RedRouterをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://github.com/reddb-io/red-router/dashboard)からのRedRouter APIキー
- RedRouterが動作中 (ローカルまたはクラウド)
...
### モデルが応答しない
- RedRouterが動作中か確認: `curl http://localhost:25050/health`
