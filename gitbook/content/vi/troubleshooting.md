...
Các vấn đề và giải pháp phổ biến khi dùng RedRouter.
...
1. **Auto-refresh (mặc định):**
   RedRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra RedRouter có chạy không:**
   ```bash
   # Check process
