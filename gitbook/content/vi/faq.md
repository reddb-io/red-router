...
Những câu hỏi phổ biến về RedRouter.

---

## RedRouter là gì?

**RedRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**RedRouter dùng chiến lược pricing 3 tầng:**
...
## RedRouter có miễn phí không?

**Có, RedRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của RedRouter.**
...
**RedRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host RedRouter không?

**Có! RedRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.red-router`)
...
**Có, RedRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.red-router` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server RedRouter
...
## Làm thế nào để cập nhật RedRouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/reddb-io/red-router/blob/main/CHANGELOG.md)
- Backup `~/.red-router` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/reddb-io/red-router/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [github.com/reddb-io/red-router/docs](https://github.com/reddb-io/red-router/docs)
