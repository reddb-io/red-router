...
Triển khai RedRouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.red-router` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/red-router`:
...
# If NOT using reverse proxy, allow RedRouter ports
