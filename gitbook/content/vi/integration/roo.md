...
Tích hợp RedRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model RedRouter có sẵn:
...
### Connection Failed
- Xác minh RedRouter đang chạy: `curl http://localhost:25050/health`
