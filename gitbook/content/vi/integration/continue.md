...
Tích hợp RedRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- RedRouter API key từ [dashboard](https://github.com/reddb-io/red-router/dashboard)
- RedRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model RedRouter
...
3. Chọn model RedRouter ưa thích
...
- Kiểm tra RedRouter đang chạy: `curl http://localhost:25050/health`
...
- Kiểm tra độ trễ network đến RedRouter
