...
RedRouter tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

RedRouter cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến RedRouter bằng các cài đặt sau:

**RedRouter cục bộ:**
```
Base URL: http://localhost:25050/v1
API Key: your-api-key-from-dashboard
Model: any RedRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến RedRouter
```bash
# Check if RedRouter is running
...
**Giải pháp:**
- Xác minh RedRouter đang chạy
- Kiểm tra port 25050 không bị chặn
...
- Kiểm tra model có sẵn: `curl http://localhost:25050/v1/models`
...
- Kiểm tra kết nối network đến RedRouter
