...
Hướng dẫn cài đặt chi tiết cho RedRouter với mẹo troubleshooting.
...
Cài RedRouter toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `red-router`
- ✅ Auto-update với `npm update -g red-router`
...
**Điều gì xảy ra:**
1. Server khởi động tại `http://localhost:25050`
2. Dashboard tự động mở trong browser
3. Data directory được tạo tại `~/.red-router`
...
**Vấn đề:** RedRouter dùng quá nhiều RAM
...
# Delete red-router-related exports
```
