...
Common issues and solutions when using RedRouter.
...
1. **Auto-refresh (default):**
   RedRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
**Problem:** "ECONNREFUSED" or "Cannot connect to localhost:25050".

**Causes:**
- RedRouter not running
- Port 25050 blocked
...
1. **Check if RedRouter is running:**
   ```bash
   # Check process
