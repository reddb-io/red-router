...
Common questions about RedRouter.

---

## What is RedRouter?

**RedRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**RedRouter uses a 3-tier pricing strategy:**
...
**Yes, RedRouter itself is 100% free and open source.**
...
**Yes! This is RedRouter's core feature.**
...
**RedRouter tracks quota in real-time for all providers:**
...
## Can I self-host RedRouter?

**Yes! RedRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.red-router`)
...
**Yes, RedRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.red-router` (or custom `DATA_DIR`)
- No data sent to RedRouter servers
...
**What RedRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What RedRouter does NOT store:**
...
See [CONTRIBUTING.md](https://github.com/reddb-io/red-router/blob/main/CONTRIBUTING.md) for details.
