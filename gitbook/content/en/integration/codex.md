...
Integrate RedRouter with OpenAI Codex CLI to route your OpenAI API requests through RedRouter's intelligent routing system.
...
RedRouter provides the following Codex models:
...
1. Verify your API key is correct in RedRouter dashboard
...
2. Check that the OpenAI provider connection is active in RedRouter dashboard
