...
Integrate RedRouter with Claude Code CLI to route your Anthropic API requests through RedRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to RedRouter models:
...
1. Verify the model name matches your RedRouter configuration
...
Make sure you have configured your API key in the RedRouter cloud dashboard.
