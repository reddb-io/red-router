...
Integrate RedRouter with Roo AI Assistant to access multiple AI models through a unified interface.
...
Choose from available RedRouter models:
...
- Verify model is enabled in your RedRouter plan
- Try a different model from the list

### Slow Responses
- Switch to faster models (haiku, flash)
- Check network connection
- Monitor RedRouter logs for issues
