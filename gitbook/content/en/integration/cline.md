...
Integrate RedRouter with Cline VSCode extension to route your AI requests through RedRouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- RedRouter running locally or cloud endpoint configured
...
Set the base URL to your RedRouter endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your RedRouter endpoint
...
3. The key should start with `sk-red-router-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your RedRouter configuration
...
4. Cline will use RedRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using RedRouter
...
3. Get AI-powered explanations through RedRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use RedRouter to understand context and make changes
...
2. Verify your RedRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check RedRouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use RedRouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://github.com/reddb-io/red-router`
2. Make sure you have configured your API key in the RedRouter cloud dashboard
...
## Integration with RedRouter Features

### Model Routing

RedRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, RedRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through RedRouter dashboard:
- Total requests
- Token usage
- Cost per model
