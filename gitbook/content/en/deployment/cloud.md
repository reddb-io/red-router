...
Deploy RedRouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.red-router` | Database and data storage path |
...
Create `/etc/nginx/sites-available/red-router`:
