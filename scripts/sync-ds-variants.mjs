...
//
// vendor/ds/kits/base/*.variants.ts are vendored byte-for-byte from the
...
const srcDir = join(root, "vendor/ds/kits/base");
...
for (const file of readdirSync(srcDir).filter((f) => f.endsWith(".variants.ts")).sort()) {
  ...
  const header = `// GENERATED from vendor/ds/kits/base/${file} by scripts/sync-ds-variants.mjs — do not edit.\n`;
