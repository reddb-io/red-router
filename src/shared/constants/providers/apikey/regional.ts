...
export const APIKEY_PROVIDERS_REGIONAL = {
  ...
  alicode: {
    ...
    apiHint: "Use a China Alibaba Coding Plan key; Model Studio keys use another connection.",
  },
  "alicode-intl": {
    id: "alicode-intl",
    serviceKinds: ["llm"],
    ...
    apiHint: "Use an international Alibaba Coding Plan key, not a Model Studio API key.",
  },
  "alims-intl": {
    id: "alims-intl",
    serviceKinds: ["llm"],
    alias: "alims-intl",
    name: "Alibaba Model Studio (International)",
    icon: "cloud_queue",
    color: "#FF6600",
    textIcon: "AMS",
    website: "https://modelstudio.console.alibabacloud.com",
    apiHint: "Use a standard international Model Studio API key, not a Coding Plan key.",
  },
  "alitp-intl": {
    id: "alitp-intl",
    serviceKinds: ["llm"],
    alias: "alitp-intl",
    name: "Alibaba Token Plan (OpenAI)",
    icon: "cloud_queue",
    color: "#FF6600",
    textIcon: "ATP",
    website: "https://www.alibabacloud.com/help/en/model-studio/token-plan-overview",
    apiHint: "Use a Token Plan key on the Singapore OpenAI-compatible endpoint.",
  },
  longcat: {
    id: "longcat",
    serviceKinds: ["llm"],
