...
export const CORS_HEADERS = {
  ...
  "Access-Control-Allow-Headers":
    "Content-Type, Authorization, x-api-key, x-connection-id, idempotency-key, prefer, anthropic-version, x-omniroute-connection, X-OmniRoute-Lease-Owner, X-OmniRoute-Lease-Generation, x-internal-test, accept",
} as const;
