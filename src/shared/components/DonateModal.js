...
function DonateChannelCard({ channel }) {
  ...
  return (
    <div className="flex flex-col items-center p-4 rounded-xl border border-muted bg-surface/50 hover:border-pink-500/40 transition-colors">
      {content}
      {url && (
        <a
          href={url}
