        ...
        <div className="px-6 py-4 flex flex-col gap-2">
          <Link href="/dashboard" className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-text-muted">v{runtimeVersion}</span>
            </div>
          </Link>
          {updateInfo && (
  ...
  return (
    <div className="w-full max-w-lg rounded-xl bg-neutral-900/95 border border-white/10 p-6 text-white">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="text-lg font-semibold">Update RedRouter{latestVersion ? ` to v${latestVersion}` : ""}</h2>
      ...
      <ol className="text-xs text-white/70 space-y-1 list-decimal list-inside mb-4">
        ...
        <li>Run <code className="px-1 rounded bg-white/10 text-green-400">red-router</code> again after install.</li>
      </ol>
