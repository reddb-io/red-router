...
function ModelItem({ index, model, isFirst, isLast, onEdit, onMoveUp, onMoveDown, onRemove }) {
  ...
  return (
    <div className="group flex min-w-0 items-center gap-1.5 rounded-md bg-muted/50 px-2 py-1 transition-colors hover:bg-muted/50">
      ...
      {editing ? (
        ...
        <div className="min-w-0 flex-1 cursor-text truncate rounded px-1.5 py-0.5 font-mono text-xs text-text-main hover:bg-muted/50"
            ...
            {forcePrefix ? (
              <>
                ...
                <div className="flex items-stretch">
                  <span className="inline-flex items-center px-2 rounded-l border border-r-0 border-muted bg-muted/50 text-text-muted font-mono text-sm">{forcePrefix}</span>
