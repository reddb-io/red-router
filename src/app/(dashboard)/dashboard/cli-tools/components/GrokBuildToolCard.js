    ...
    <Card padding="xs" className="overflow-hidden">
      ...
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          {checking && <div className="flex items-center gap-2 text-text-muted"><Icon name="progress_activity" size={24} className="animate-spin" /><span>Checking Grok Build...</span></div>}
...
>>>>>>> feat/ds-v2026.09
              ...
              <Button variant="secondary" size="sm" onClick={() => setShowManualConfigModal(true)} className="w-full sm:w-auto"><Icon name="content_copy" size={18} className="mr-1" />Manual Config</Button>
            </div>
          )}
...
>>>>>>> feat/ds-v2026.09
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={handleReset} disabled={!grokStatus?.hasRedRouter} loading={restoring} className="w-full sm:w-auto"><Icon name="restore" size={14} className="mr-1" />Reset</Button>
                <Button variant="ghost" size="sm" onClick={() => setShowManualConfigModal(true)} className="w-full sm:w-auto"><Icon name="content_copy" size={14} className="mr-1" />Manual Config</Button>
              </div>
            </>
          )}
        </div>
