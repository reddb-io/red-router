              ...
              <div className="flex flex-col gap-3 p-4 bg-[var(--reddb-color-feedback-warning-surface)] border border-[var(--reddb-color-feedback-warning-border)] rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-[var(--reddb-color-feedback-warning-foreground)]">Hermes Agent not detected locally</p>
          ...
          {!checking && hermesStatus?.installed && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={handleReset} disabled={!hermesStatus?.hasRedRouter} loading={restoring} className="w-full sm:w-auto">
