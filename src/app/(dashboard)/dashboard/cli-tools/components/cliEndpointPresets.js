...
const endpoints = createStore({
  storageKey: "red-router.cliToolEndpointPresets",
  changeEvent: "red-router:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "red-router.cliToolApiKeyPresets",
  changeEvent: "red-router:api-key-presets-changed",
  itemField: "key",
});
