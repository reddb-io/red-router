...
const PROVIDER_NAME = "red-router";
...
// Build TOML config for RedRouter (openai provider mode)
const buildRedRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect RedRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildRedRouterConfig(baseUrl, apiKey || "sk_red-router", model);
